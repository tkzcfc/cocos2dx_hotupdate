...
Button_Update:setTitleText("Button")
...
Button_Update:setPosition(470.9892, 211.1047)
...
layout:setLeftMargin(394.9843)
layout:setRightMargin(413.0059)
layout:setTopMargin(410.8953)
layout:setBottomMargin(193.1047)
